import {
  ...
  pickBy,
  uniq
} from "./chunk-OBYE2OS6.js";
import {
  renderElement,
  unmountElement
} from "./chunk-MZX6XGOV.js";
import "./chunk-EBLNVHI4.js";
import {
  $u,
  $u2,
  Bl,
  ...
  wt,
  yu
} from "./chunk-45AJWDNZ.js";
import "./chunk-H4VPUHQX.js";
import "./chunk-AHGZ457G.js";
import {
  z
} from "./chunk-PAHQDDTA.js";
import {
  gt,
  yn
} from "./chunk-V36SZGQW.js";
import "./chunk-FDBWMMNE.js";
import "./chunk-FSV62XUO.js";
import {
  require_react
} from "./chunk-6256QYRB.js";
import "./chunk-WIFMKQIK.js";
import {
  dedent
...
// node_modules/.pnpm/@storybook+addon-docs@8.6.12_@types+react@19.1.2_storybook@8.6.12_prettier@2.8.8_/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// node_modules/.pnpm/@storybook+blocks@8.6.12_react-dom@19.0.0_react@19.0.0__react@19.0.0_storybook@8.6.12_prettier@2.8.8_/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-KS32EH6I.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-UDESYEJ4.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-5W6RTLXM.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-KCJUA2RZ.js.map
